            ...
            ListTile(
              ...
              title: SizedBox(
                  ...
                  child: ListView(
                    ...
                    children: [
                      _buildColorSelector('red'),
                      _buildColorSelector('blue'),
                      _buildColorSelector('green'),
                      _buildColorSelector('yellow'),
                      _buildColorSelector('purple'),
                      _buildColorSelector('pink'),
                      _buildColorSelector('orange'),
                      _buildColorSelector('black'),
                      _buildColorSelector('indigo'),
                      _buildColorSelector('cyan'),
                    ],
                  )),
            ),
          ],
